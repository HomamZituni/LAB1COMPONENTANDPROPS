...
How to pass and render the `children` pop correctly. How to import the SVGs in correctly was also a huge challene. Figuring out the type-only imports to get the SVGs and other components to work properly once displayed and once deployed.
